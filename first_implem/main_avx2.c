...
int main() {
  ...
  uint64_t result[2] = {1188967911021090315, 16777248};
  ...
  /* output expected: 369435925020741 72057594054705152 4294967296  */
  /* output expected: 369435925020741 72127962798882832 281474977760256 */
  long long int S2 = 0;
  for(int i = 0; i < NBR_TEST; ++i){
