...
On pose $t= \lceil m / W \rceil$ correspondant aux nombres de mots de $W-bit$ pour representer $a$. Au final on peut donner une structure de tableau à un élément du corps: $A= (A[t-1],\ldots ,A[1],A[0])$.
